...
public class Table {
    ...
    //获取字段名及类型
    public void getTypeAndField(ResultSetMetaData resultSetMetaData) throws Exception {
        Field field;
        Other.tableName = conversion(resultSetMetaData.getTableName(1));
        Other.tableNamen = resultSetMetaData.getTableName(1);
